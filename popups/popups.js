window.popupStrings = {
    ...
    'weeks': '周',
    'search': '搜索',
    'SearchHint': '搜索包含%s的页面',
    'web': '站点',
    'global': '全域',
    'globalSearchHint': '在所有维基媒体项目中搜索%s',
    'googleSearchHint': '用Google搜索%s',
    'more...': '更多...',
    'actions': '动作',
    'popupsMenu': 'Popups',
    'enable previews': '启用预览',
    'disable previews': '禁用预览',
    'togglePreviewsHint': '切换本页Popups的预览开关',
    'toggle previews': '切换预览开关',
    'reset': '复位',
    'disable': '禁用Popups',
    'disablePopupsHint': '在本页禁用Popups，刷新页面以重新启用。',
    'historyfeedHint': '本页最近更改的RSS Feed',
    'purgePopupsHint': '复位Popups，清除所有缓存数据。',
    'PopupsHint': '复位Popups，清除所有缓存数据。',
    'spacebar': '空格',
    'view': '查看',
    'view article': '查看条目',
    'viewHint': '前往%s',
    ...
    'talk page': '讨论页',
    'this&nbsp;revision': '此修订版本',
    'revision %s of %s': '页面$2的修订版本$1',
    'Revision %s of %s': '页面$2的修订版本$1',
    'the revision prior to revision %s of %s': '页面$2的修订版本$1之前的修订版本',
    'Toggle image size': '点击切换图片大小',
    'del': '删除',
    'delete': '删除',
    'deleteHint': '删除%s',
    'undeleteShort': '反',
    ...
    'protectHint': '保护%s',
    'unprotectShort': '解除',
    'unprotectHint': '解除对%s的保护',
    'move': '移动',
    'move page': '移动页面',
    'MovepageHint': '修改%s的标题',
    'edit': '编辑',
    'edit article': '编辑条目',
    'editHint': '修改%s的内容',
    'edit talk': '编辑讨论页',
    'new': '新',
    'new topic': '新主题',
    'newSectionHint': '在%s增加新的评论主题',
    'null edit': '空编辑',
    'nullEditHint': '制造一次对%s的空编辑',
    'hist': '历史',
    'history': '历史',
    'historyHint': '%s的修订历史',
    'last': '最近',
    ...
    'Show the last edit': '显示最近一次更改的差异',
    'lastContrib': '最近编辑',
    'last set of edits': '最近编辑',
    'lastContribHint': '显示由最后一位编辑者制造的差异',
    'cur': '当前',
    'diffCur': '与当前版本的差异',
    'Show changes since revision %s': '显示自修订版本%s的差异',
    '%s old': '%s前',
    'oldEdit': '旧编辑',
    'purge': '清除缓存',
    ...
    'rawHint': '查看%s的源代码',
    'render': '简单',
    'renderHint': '显示%s的纯HTML解析',
    'Show the edit made to get revision': '显示编辑以得到修订版本',
    'sinceMe': '自我',
    'changes since mine': '自我修订的差异',
    'sinceMeHint': '显示自我上次修改以来的差异',
    'Couldn\'t find an edit by %s\nin the last %s edits to\n%s': '在$3最近$2次编辑中找不到$1做出的修改',
    'eds': '编辑',
    'editors': '编辑者',
    'editorListHint': '列出编辑过%s的用户',
    'related': '相关',
    'relatedChanges': '相关更改',
    'related changes': '相关更改',
    'RecentchangeslinkedHint': '显示相关%s的修改',
    'editOld': '编辑旧版',
    'rv': '回退',
    'revert': '回退',
    'revertHint': '回退到 %s',
    'undo': '撤销',
    'undoHint': '撤销这次编辑',
    'defaultpopupRedlinkSummary': '取消到空页面[[%s]]的链接，通过[[WP:POP|popups]]',
    'defaultpopupFixDabsSummary': '消歧义[[%s]]到[[%s]]，通过[[WP:POP|popups]]',
    'defaultpopupFixRedirsSummary': '忽略从[[%s]]到[[%s]]的重定向，通过[[WP:POP|popups]]',
    'defaultpopupExtendedRevertSummary': '回退到$2在$1时制作的修订版本$3，通过[[WP:POP|popups]]',
    'defaultpopupRevertToPreviousSummary': '回退到修订版本%s的上一个版本，通过[[WP:POP|popups]]',
    'defaultpopupRevertSummary': '回退到修订版本%s，通过[[WP:POP|popups]]',
    'defaultpopupQueriedRevertToPreviousSummary': '回退到修订$1（由$3在$2时制作）的上一个修订版本，通过[[WP:POP|popups]]',
    'defaultpopupQueriedRevertSummary': '回退到$3在$2时制作的修订版本$1，通过[[WP:POP|popups]]',
    'defaultpopupRmDabLinkSummary': '移除到消歧义页[[%s]]的链接，通过[[WP:POP|popups]]',
    'Redirects': '重定向',
    ' to ': '至',
    'Bypass redirect': '忽略重定向',
    'Fix this redirect': '修复重定向',
    'disambig': '消歧义',
    'disambigHint': '消歧义这个链接到[[%s]]',
    'Click to disambiguate this link to:': '点击以消歧义这个链接到：',
    'remove this link': '移除链接',
    'remove all links to this page from this article': '移除此条目到这页的所有链接',
    'remove all links to this disambig page from this article': '移除此条目到这消歧义的所有链接',
    'mainlink': '主链接',
    'wikiLink': '内部链接',
    'wikiLinks': '内部链接',
    'links here': '链入',
    ...
    'WhatlinkshereHint': '显示链接到%s的页面',
    'unwatchShort': '取消',
    'watchThingy': '监视',
    'watchHint': '将%s加入到我的监视列表',
    'unwatchHint': '从我的监视列表移除%s',
    'Only found one editor: %s made %s edits': '仅找到一位编者：%s作出了%s次编辑',
    '%s seems to be the last editor to the page %s': '%s看上去是%s这页的最后一位编者',
    'rss': 'RSS',
    'Diff truncated for performance reasons': '差异已被截断',
    'Old revision': '旧版本',
    'New revision': '新版本',
    'Something went wrong :-(': '出问题了:-(',
    'Empty revision, maybe non-existent': '空的修订，可能并不存在',
    'Unknown date': '未知日期',
    'Empty category': '空的分类',
    'Category members (%s shown)': '分类成员（%s显示）',
    'No image links found': '未找到文件链接',
    'File links': '文件链接',
    'not commons': '维基共享中无此名称的文件。',
    'commons only': '此文件来自维基共享。',
    'No image found': '找不到文件',
    'commons dupe': '维基共享中存在此文件的副本。',
    'commons conflict': '维基共享中存在此文件名称不同的副本。',
    'user': '用户',
    'user&nbsp;page': '用户页',
    'user talk': '用户讨论',
    'edit user talk': '编辑用户讨论',
    'leave comment': '留言',
    'email': '电邮',
    'email user': '电邮用户',
    'EmailuserHint': '给%s发送电子邮件',
    'space': '空间',
    'PrefixIndexHint': undefined,
    'count': '统计',
    'edit counter': '编辑次数',
    'katelinkHint': '%s的编辑次数',
    'contribs': '贡献',
    'contributions': '贡献',
    'deletedContribs': '已删除的贡献',
    'ContributionsHint': undefined,
    'tree': '树',
    'contribsTreeHint': '根据命名空间查看%s的贡献',
    'log': '日志',
    'user log': '用户日志',
    'userLogHint': undefined,
    'arin': 'ARIN查询',
    'Look up %s in ARIN whois database': '在ARIN Whois数据库中查询%s',
    'unblockShort': '解除',
    'block': '封禁',
    'block user': '封禁用户',
    ...
    'BlockipHint': '封禁%s',
    'block log': '封禁日志',
    'blockLogHint': '显示%s的封禁日志',
    'protectLogHint': '显示%s的保护日志',
    'pageLogHint': '显示%s的日志',
    'deleteLogHint': '显示%s的删除日志',
    'Invalid %s %s': '选项%s不可用：%s',
    'Enter a non-empty edit summary or press cancel to abort': '输入编辑摘要，或按取消中止操作',
    'Failed to get revision information, please edit manually.\n\n': '获取修订版本信息失败，请手动修改。\n\n',
    'The %s button has been automatically clicked. Please wait for the next page to load.': '按钮%s已被自动点击，请等待下一个页面加载。',
    'Could not find button %s. Please check the settings in your javascript file.': '找不到按钮%s，请检查您JavaScript文件中的设置。',
    'Open full-size image': '查看全尺寸图像',
    'zxy': 'zxy',
    'globalSearchHint': "在维基百科其他语言搜索“%s”",
    'googleSearchHint': "在Google上搜索“%s”",
    'enable previews': "启用预览",
    'show preview': "禁用预览",
    'historyfeedHint': "该页面的近期更改RSS feed",
    'send thanks': "发送感谢",
    'ThanksHint': undefined,
    'mark patrolled': "标记为已巡查",
    'markpatrolledHint': "标记该编辑为已巡查",
    'Could not marked this edit as patrolled': "无法标记该编辑为已巡查",
    'defaultpopupReviewedSummary': "标记从版本%s到%s间的编辑为已巡查",
    'Image from Commons': "来自维基共享资源的图片",
    'Description page': "图片描述页",
    'Alt text:': "替换文本（Alt）：",
    'revdel': "历史版本被隐藏",
    'editCounterLinkHint': undefined,
    'DeletedcontributionsHint': undefined,
    'No backlinks found': "找不到链入页面",
    'and more': "以及其他页面",
    'Download preview data': "下载预览数据",
    'Invalid or IP user': undefined,
    'Not a registered username': undefined,
    'BLOCKED': "被封禁",
    'Has blocks': "被部分封禁",
    ' edits since: ': "次编辑，注册日期为",
    'last edit on ': "最后一次编辑于",
    'EmailUserHint': "给%s发送电子邮件",
    'RANGEBLOCKED': "IP段被封禁",
    'IP user': undefined,
    '♀': "♀",
